...
// 5 تاكيد الغياب بتسجيل طلب اخر
  ...
  const renderStepIndicators = () => {
    ...
    if (buttonStatus === 1 || buttonStatus === 5) {
      steps = ["تحديد الصنايعية اولا", "تحديد المساعدين ثانيا", "تاكيد الطلب"];
    } else if (buttonStatus === 3) {
      steps = ["تعديل الصنايعية اولا", "تعديل المساعدين ثانيا", "تاكيد التعديل"];
    } else if (buttonStatus === 4) {
      steps = ["تاكيد عدد الصنايعية اولا", "تاكيد عدد  المساعدين ثانيا", "تاكيد الحضور"];
    } else {
      steps = ['اجراء مكالمة'];
    }
