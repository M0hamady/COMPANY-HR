      ...
      {loading ? (
        ...
        <div className="flex flex-col sm:flex-row gap-2 bg-[#071e34] max-w-[100vw]">
          ...
          <div className="p-4 flex flex-col gap-2 h-[100vh] sm:w-5/7 sm:h-[40vh] max-w-[66vw] max-sm:max-w-[99vw] ">
            ...
            <div className="row-span-7 text-white flex flex-row justify-around flex-wrap gap-2 overflow-auto absolute bottom-0 max-sm:-bottom-[40vh] h-[700px] max-sm:h-[740px] ">
